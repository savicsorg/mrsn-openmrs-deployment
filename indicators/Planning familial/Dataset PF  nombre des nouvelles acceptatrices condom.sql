 select
    ...
    and ((o.`concept_id`=4936 and o.`value_coded`=1) or (o.`concept_id`=4931 and o.`value_coded`=1) or (o.`concept_id`=4929 or o.`value_coded`=1 ) or (o.`concept_id`=4930 or o.`value_coded`=1 ))
	and  o.`concept_id` in (4936,4931,4929,4930)
