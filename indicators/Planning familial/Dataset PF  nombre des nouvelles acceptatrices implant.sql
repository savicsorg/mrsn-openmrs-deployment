 select
    ...
    and ((o.`concept_id`=4925 and o.`value_coded`=1) or (o.`concept_id`=4926 and o.`value_coded`=1) or (o.`concept_id`=4927 or o.`value_coded`=1 ) or (o.`concept_id`=4928 or o.`value_coded`=1 ))
	and  o.`concept_id` in (4925,4926,4927,4928)
